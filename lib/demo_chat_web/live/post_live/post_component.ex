defmodule DemoChatWeb.PostLive.PostComponent do
  use DemoChatWeb, :live_component
  ...
  def handle_event("like", _, socket) do
    DemoChat.Timeline.inc_likes(socket.assigns.post)
    {:noreply, socket}
  end

  def handle_event("repost", _, socket) do
    DemoChat.Timeline.inc_reposts(socket.assigns.post)
    {:noreply, socket}
  end
end
